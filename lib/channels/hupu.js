...
var request = r.defaults({proxy: "http://16.153.99.10:8080"});
    ...
    if (trs.length) {
        ...
        if (newSid && newSid != self.sid) {
            ...
            trs.each(function (i, tr) {
                ...
                if (tds.length == 4) {
                    datas.unshift({
                        time: tds[0].children[0].data,
                        team: tds[1].children[0].data,
                        content: tds[2].children[0].data,
                        score: tds[3].children[0].data
                    });
                } else if (tds.length == 1) {
                    datas.unshift({
                        content: tds[0].children[0].data
                    });
                }
            });
